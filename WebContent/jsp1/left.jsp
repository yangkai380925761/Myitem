  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="${pageContext.request.contextPath }/user/toAddUser" target="main">基本设置</a></li>
          <li><a href="${pageContext.request.contextPath }/user/getAllUser" target="main">邮件设置</a></li>
