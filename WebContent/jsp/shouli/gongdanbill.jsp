	...
	$(function(){
		$('#dg').datagrid({
		    ...
		    columns: [[
		        ...
		        { field: 'type', title: '工单类型', width: 150},
		        { field: 'pickstate', title: '取件状态', width: 150},
		        { field: 'attachbilltimes', title: '追单次数', width: 150},
		        { field: 'Staff', title: '取派员', width: 150},
		        { field: 'updateTime', title: '修改时间', width: 120,align: 'center',formatter: formatDatebox}
		    ]],		
...
<div id="contain" >
	...
	<div id="tb" style="height:auto;">		
		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="destroyBean()">销单</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-redo',plain:true" onclick="add()">追单</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-undo',plain:true" onclick="back()">返回上一层</a>
	</div>	
